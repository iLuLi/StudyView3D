define([
    ...
    function Viewer3DImpl(thecanvas, theapi) {
        ...
        var _phase = Privite_Global.RENDER_NORMAL;
        ...
        this.initialize = function () {
            ...
            var cc = LightPresets[Privite_Global.DefaultLightPreset].bgColorGradient;
        ...
        function renderSomeCallback(scene) {
            ...
            var phase = _phase;
            var wantColor = true;
            var wantSAO = phase == Privite_Global.RENDER_NORMAL;
            var wantID = _renderer.settings.idbuffer && phase != Privite_Global.RENDER_HIDDEN;

            if (phase == Privite_Global.RENDER_HIDDEN)
                scene.overrideMaterial = _this.fadeMaterial;
            else if (phase == Privite_Global.RENDER_HIGHLIGHTED)
                ...
                if (!_groundReflection.rendered &&
                    ...
                    if (_modelQueue.isDone()) {
                        ...
                        if (_this.showGhosting && !_modelQueue.areAllVisible()) {
                            _phase = Privite_Global.RENDER_HIDDEN;
        ...
        function tick(highResTimeStamp) {
            ...
            if (!q.isEmpty() && !q.isDone()) {
                ...
                if (q.isDone() && _phase === Privite_Global.RENDER_HIGHLIGHTED) {
                    _phase = Privite_Global.RENDER_NORMAL;
                ...
                if (q.isDone()) {
                    if (_phase === Privite_Global.RENDER_NORMAL &&
                        !q.areAllVisible() &&
                        _this.showGhosting) {
                        ...
                        _phase = Privite_Global.RENDER_FINISHED;
        ...
        this.addModel = function (model) {
            ...
            if (is2d) {
                ...
                if (!isOverlay) {
                    ...
                    this.setLightPreset(Privite_Global.DefaultLightPreset2d);
        ...
        this.setLightPreset = function (index, force) {
            ...
            if (index < 0 || LightPresets.length <= index) {
                index = Privite_Global.DefaultLightPreset;
            }
