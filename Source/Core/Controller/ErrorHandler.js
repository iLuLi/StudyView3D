define([
    ...
    '../Constants/Error',
    '../../UI/Base/AlertBox'
], function(Global, Logger, i18n, Error, AlertBox) {
    'use strict';
    ...
    ErrorHandler.reportError = function (container, errorCode, errorMsg, statusCode, statusText, errorType) {
        ...
        var errorInfo = Error.ErrorInfoData[errorCode];
        if (errorInfo) {
            var options = {
                "defaultValue": ""
            };
            ...
            if (errorCode === Global.ErrorCodes.BROWSER_WEBGL_DISABLED ||
                ...
                var WEBGL_HELP_LINK = Global.WEBGL_HELP_LINK || "http://www.autodesk.com/a360-browsers";
