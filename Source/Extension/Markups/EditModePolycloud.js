define([
    ...
    './SetPolycloud',
    './CreatePolycloud'
], function(EditMode, Constants, DeletePolycloud, SetPolycloud, CreatePolycloud) {
    'use strict';
    var SNAP_RANGE = 25;
        ...
        function EditModePolycloud(editor) {
            ...
            EditMode.call(this, editor, Constants.MARKUP_TYPE_POLYCLOUD, styleAttributes);
        ...
        proto.onMouseMove = function (event) {
            ...
            if (movements.length >= 2 &&
                Utils.areMarkupsPointsInClientRange(movements[0], mousePosition, SNAP_RANGE, this.editor)) {
        ...
        proto.onMouseUp = function (event) {
            ...
            if (movements.length > 1 &&
                Utils.areMarkupsPointsInClientRange(movements[movements.length - 2], mousePosition, SNAP_RANGE, this.editor)) {
                return;
            }
