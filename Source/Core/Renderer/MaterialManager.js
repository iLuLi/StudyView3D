define([
    '../Logger',
    './Utils/MaterialConverter',
    './Utils/CreateCubeMapFromColors',
    './Utils/CreateLinePatternTexture',
    './Utils/clonePrismMaterial',
    '../Utils/pathToURL',
    '../Math/DecodeEnvMap',
    '../Constants/Global',
    '../Constants/DeviceType',
    '../Shaders/LineShader',
    '../Service/loadTextureWithSecurity'
], function(
    Logger, 
    MaterialConverter, 
    ...
    function MaterialManager(viewer) {
        ...
        this.convertMaterials = function (svf) {
            ...
            for (var p in prmats) {
                ...
                if (!DeviceType.isIE11 && svf.doubleSided)
