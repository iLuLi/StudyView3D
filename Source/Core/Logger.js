    ...
    DeviceType
        ...
        */
        ...
        function Logger() {
            ...
            this.runtimeStats = {};
            this.level = -1;
            this.setLevel(Global.ENABLE_TRACE ? Global.LogLevels.DEBUG : Global.LogLevels.ERROR);
        }
        ...
        Logger.prototype.track = function (entry) {
            ...
            if (Global.offline || !this.sessionId) {
                return;
            }
