define([
...
], function(EventType, DeviceType, Global, Instance, pathToURL, Inits, createWorkerWithIntercept) {
    'use strict';

    var InstanceTree = Instance.InstanceTree,
        InstanceTreeAccess = Instance.InstanceTreeAccess,
    ...
    var PropDbLoader = function (sharedDbPath, model, eventTarget) {
        ...
        var domainParam = (Global.auth && !Global.isNodeJS) ? ("domain=" + encodeURIComponent(window.location.origin)) : "";
