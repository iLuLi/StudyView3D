define([
    ...
    './SetPosition',
    './SetRotation'
], function (Hammer, Constants, CloneMarkup, SetSize, SetPosition, SetRotation) {
    'use strict';
    /**
    ...
    proto._onRepositionMouseDown = function (event, cursor) {
        ...
        this.fireEvent({ type: Constants.EVENT_EDITFRAME_EDITION_START }); // Moving around
    };
    ...
    proto._onRepositionMouseUp = function () {
        ...
        this.selection.dragging = false;
        this.fireEvent({ type: Constants.EVENT_EDITFRAME_EDITION_END }); // Moving around
    };
    ...
    proto._onResizeMouseDown = function (event) {
        ...
        this.fireEvent({ type: Constants.EVENT_EDITFRAME_EDITION_START }); // Resizing
    };
    ...
    proto._onResizeMouseUp = function (event) {
        ...
        this.editor.closeActionGroup();
        this.fireEvent({ type: Constants.EVENT_EDITFRAME_EDITION_END }); // Resizing
    ...
    proto._onRotationMouseDown = function (event) {
        ...
        this.fireEvent({ type: Constants.EVENT_EDITFRAME_EDITION_START }); // Rotating
    };
    ...
    proto._onRotationMouseMove = function (event) {
        ...
        if (this.editor.input.snapRotations) {
            var snap = Utils.degreesToRadians(22.5);
    ...
    proto._onRotationMouseUp = function (event) {
        ...
        this.editor.closeActionGroup();
        this.fireEvent({ type: Constants.EVENT_EDITFRAME_EDITION_END }); // Rotating
    };
