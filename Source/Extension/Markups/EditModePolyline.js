define([
    ...
    './SetPolyline',
    './CreatePolyline'
], function(EditMode, Constants, DeletePolyline, SetPolyline, CreatePolyline) {
    'use strict';
    var SNAP_RANGE = 25;
        ...
        function EditModePolyline(editor) {
            ...
            EditMode.call(this, editor, Constants.MARKUP_TYPE_POLYLINE, styleAttributes);
