define(['./Constants/EventType'], function(EventType) {;
    ...
    var WorldUpTool = function (viewerImpl, viewerApi) {
        ...
        this.activate = function (name) {
            viewerApi.addEventListener(EventType.CAMERA_CHANGE_EVENT, this.handleCameraChange);
            _started = false;
        };
    
        this.deactivate = function (name) {
            _rollInteraction.end();
            viewerApi.removeEventListener(EventType.CAMERA_CHANGE_EVENT, this.handleCameraChange);
        ...
        this.handleButtonDown = function (event, button) {
            ...
            viewerApi.removeEventListener(EventType.CAMERA_CHANGE_EVENT, self.handleCameraChange);
        ...
        this.handleButtonUp = function (event, button) {
            ...
            viewerApi.addEventListener(EventType.CAMERA_CHANGE_EVENT, self.handleCameraChange);
