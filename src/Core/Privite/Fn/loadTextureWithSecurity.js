define([
    './urlIsApiViewingOrDev',
    '../../Global',
    './initLoadContext',
    '../../Logger',
    '../ViewingService'
], function(urlIsApiViewingOrDev, Global, initLoadContext, Logger, ViewingService) {
    'use strict';
    function loadTextureWithSecurity(path, mapping, callback, acmSessionId) {
        ...
        var ossPath = ViewingService.getDirectOSSUrl({ oss_url: OSS_URL }, path);
        if (ossPath)
            path = ossPath;
