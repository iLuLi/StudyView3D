define(['./Core/Privite/Fn/getResourceUrl'], function(getResourceUrl) {;
    'use strict'
    // i18next, v1.7.3
        ...
        _fetch: function (lngs, options, cb) {
            ...
            if (!options.dynamicLoad) {
                ...
                if (typeof options.customLoad == 'function') {
                    ...
                    url = Private.getResourceUrl(url);
    ...
    var localize = function () {
        ...
        Array.prototype.forEach.call(document.querySelectorAll('[data-i18n]'), function (element) {
            ...
            var translatedString = i18n.translate(stringToTrans);
            if (translatedString) {
                if (attributeName) {
    ...
    i18n.options = o;
    i18n.setDebugLocString = setDebugLocString;
    i18n.clearDebugLocString = clearDebugLocString;
