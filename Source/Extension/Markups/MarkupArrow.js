define([
    ...
    './Constants',
    './EditModeArrow'
], function(Markup, Utils, Constants, EditModeArrow) {
    'use strict';
    /**
     *
     * @param id
    ...
    function MarkupArrow(id, editor) {
                ...
                this.type = Constants.MARKUP_TYPE_ARROW;
            ...
            proto.generatePoint3d = function (idTarget) {
                ...
                var point2d = Utils.checkLineSegment(head.x, head.y, head.x + direction.x * 200, head.y + direction.y * 200, idTarget);
