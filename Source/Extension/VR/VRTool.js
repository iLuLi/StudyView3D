define(['../../Core/i18n', '../../Core/Manager/theHotkeyManager', '../../Core/Utils/FullscreenTool'], function(i18n, theHotkeyManager, FullscreenTool) {;
    'use strict'
    var launchFullscreen = FullscreenTool.launchFullscreen,
        exitFullscreen = FullscreenTool.exitFullscreen;

    return function (viewer, vrExtension) {
            ...
            var _keys = theHotkeyManager.KEYCODES;
