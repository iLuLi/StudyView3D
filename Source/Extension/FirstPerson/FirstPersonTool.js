define([
    ...
    '../GamepadModule',
    '../../UI/HudMessage'
], function (stringToDOM, keyCode, GamepadModule, HudMessage) {
    'use strict';
    return function (viewerapi) {
        ...
        var showHUD = function (messageSpecs, showDelay, closeCB, buttonCB, checkboxCB) {
            ...
            HudMessage.displayMessage(_container, messageSpecs, closeCB, buttonCB, checkboxCB);
        ...
        var hideHUD = function () {
            ...
            // Does not comply with headless viewer policy.
            if (HudMessage) {
                HudMessage.dismiss();  // in case it's still visible
            }
            _hudMessageStartShowTime = -1;
        };
