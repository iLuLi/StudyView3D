define([
    ...
    './Utils',
    './EditModeFreehand'
], function(Markup, Constants, Utils, EditModeFreehand) {
    'use strict';
    /**
     *
     * @param id
    ...
    function MarkupFreehand(id, editor) {
                ...
                this.type = MARKUP_TYPE_FREEHAND;
                this.shape = Utils.createMarkupPathSvg();
        
                this.bindDomEvents();
            }
        
            MarkupFreehand.prototype = Object.create(Markup.prototype);
